...
def main():
    ...
    # osaka = (math.radians(34.701859999999996), math.radians(135.49499))
    # tokyo = (math.radians(35.681129999999996), math.radians(139.76706000000001))
    # print(distance(osaka, tokyo))
